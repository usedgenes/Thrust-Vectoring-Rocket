...
void writeServos(int servoPosition_X, int servoPosition_Y) {
  if(servoPosition_X < MIN_POSITION) {
    ...
    servoPosition_X = MAX_POSITION + servoStartingPosition[0];
  } else {
    servoPosition_X = servoPosition_X + servoStartingPosition[0];
  }

  if(servoPosition_Y < MIN_POSITION) {
    servoPosition_Y = MIN_POSITION + servoStartingPosition[1];
  }
  else if(servoPosition_Y > MAX_POSITION) {
    servoPosition_Y = MAX_POSITION + servoStartingPosition[1];
  } else {
    sservoPosition_Y = servoPosition_Y + servoStartingPosition[1];
  }
...
void setServoPosition(int servoX, int servoY) {
